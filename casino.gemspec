...
Gem::Specification.new do |s|
  ...
  s.authors     = ['Nils Caspar', 'Raffael Schmid', 'Samuel Sieg','Alexey Alexandrov']
  s.email       = ['ncaspar@me.com', 'raffael@yux.ch', 'samuel.sieg@me.com','aleksandrov1988@gmail.com']
  ...
  s.add_runtime_dependency 'addressable', ['>= 2.4.0', '< 2.5.0']
